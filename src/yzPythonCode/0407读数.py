...
#starttick = 54427247860000 54426927860000
starttick =   54426927860000
num_epochs = 30
readFOLDER_ACTION = 0.95#2025#0.82025
...
readFOLDER_ACTION_ad = 0.4
directory = os.path.join(base_directory, f"inj_{readFOLDER_ACTION_ad}")
# 存放所有 epoch 的原始字符串数据
all_epochs_data_AD = []
